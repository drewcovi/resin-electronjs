...
define('thermostat/tests/app.lint-test', [], function () {
  ...
  QUnit.test('components/realtime-clock.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/realtime-clock.js should pass ESLint\n\n');
  });

  QUnit.test('components/temperature-control.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/temperature-control.js should pass ESLint\n\n');
  });
